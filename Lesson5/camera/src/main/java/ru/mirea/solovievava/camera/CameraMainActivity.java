package ru.mirea.solovievava.camera;
...
import ru.mirea.solovievava.camera.databinding.ActivityCameraMainBinding;
...
public class CameraMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCameraMainBinding.inflate(getLayoutInflater());
            ...
            public void onClick(View v) {
                ...
                if (isWork) {
                    try {
                        ...
                        imageUri = FileProvider.getUriForFile(CameraMainActivity.this, authorities, photoFile);
